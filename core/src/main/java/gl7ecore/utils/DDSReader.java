...
public final class DDSReader {
	...
	public static BufferedImage read(InputStream is) throws IOException {
        ...
        int[] pixels=read(buffer, ARGB, 0);
        BufferedImage bim=new BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB_PRE);
        bim.setRGB(0,0,width,height,pixels,0,width);
        return bim;
    }
